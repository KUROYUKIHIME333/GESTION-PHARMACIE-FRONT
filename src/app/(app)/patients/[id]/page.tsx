						...
						<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
							<div className="flex items-center gap-3">
								<Button
									...
									variant="ghost"
									size="sm"
									className="cursor-pointer text-slate-500 hover:text-[#4B866B] hover:text-[#56AC35] rounded-[2px]"
								>
									<ArrowLeft size={18} />
								</Button>
								<div>
							...
							<div className="flex gap-2 w-full sm:w-auto">
								<Button
									...
									className="flex-1 sm:flex-none gap-2 items-center font-bold text-white px-4 py-2 hover:bg-[#4B866B] bg-[bg-[#56AC35] rounded-[2px]"
								>
									<Pencil size={16} />
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
							...
							<DetailSection title="Identité" icon={<User size={20} />}>
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
									...
									<DetailField
										label="Sexe"
										value={patient.gender === 'MALE' ? 'Masculin' : patient.gender === 'FEMALE' ? 'Féminin' : patient.gender === 'OTHER' ? 'Autre' : 'Inconnu'}
									/>
