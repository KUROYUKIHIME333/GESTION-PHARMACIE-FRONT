...
import { NAV_ITEMS, APP_NAME, ROLE_LABELS } from '@/src/lib/constants';
import { cn } from '@/src/lib/utils';
import { LayoutDashboard, Pill, Package, Users, FileText, ShoppingCart, AlertTriangle, LogOut, Menu, X } from 'lucide-react';
...
export function Sidebar({ onLogout }: SidebarProps) {
	...
	return (
		<>
			...
			{/* Desktop sidebar */}
			<aside className="hidden lg:flex lg:w-72 lg:flex-col lg:fixed lg:inset-y-0 bg-white border-r border-slate-200 z-30">{navContent}</aside>
